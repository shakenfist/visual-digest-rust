...
use crate::format::{
    ...
    PHASE_PARKED, PHASE_STREAM_EXERCISE, RECORD_HASH_SIZE, TAG_BOOTLOADER_DECISION,
    TAG_BOOTLOADER_TIMEOUT, TAG_HASH_BOOTLOADER_DECISION, TAG_HASH_BOOTLOADER_TIMEOUT,
    TAG_HASH_KEYPRESS, TAG_HASH_LINE_RENDERED, TAG_HASH_MODE_CYCLE, TAG_HASH_MODE_SWITCH,
    TAG_HASH_PASTE_RECEIVED, TAG_HASH_SCENE_TRANSITION, TAG_KEYPRESS, TAG_LINE_RENDERED,
    TAG_MODE_CYCLE, TAG_MODE_SWITCH, TAG_PASTE_RECEIVED, TAG_SCENE_TRANSITION,
};
...
fn decode_phase(byte: u8) -> Option<Phase> {
    match byte {
        ...
        PHASE_STREAM_EXERCISE => Some(Phase::StreamExercise),
